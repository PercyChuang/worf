...
public class ToStringBuilder implements Builder<String> {
    public static final String[] OBFUSCATE = { "password", "passwd", "pwd", "idno", "card", "paycode", "realname",
            "mobile", "phone", "cvv", "cert" };
    ...
    public static <T> String reflectionToString(T object, ToStringStyle style, boolean outputTransients,
