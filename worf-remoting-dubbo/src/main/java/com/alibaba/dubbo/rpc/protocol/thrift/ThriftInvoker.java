...
public class ThriftInvoker<T> extends AbstractInvoker<T> {
    ...
    public ThriftInvoker(final Class<T> service, final URL url, final ExchangeClient[] clients) {
        this(service, url, clients, null);
    }

    public ThriftInvoker(final Class<T> type, final URL url, final ExchangeClient[] clients,
