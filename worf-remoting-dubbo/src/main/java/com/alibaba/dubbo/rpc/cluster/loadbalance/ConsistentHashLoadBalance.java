...
public class ConsistentHashLoadBalance extends AbstractLoadBalance {
    ...
    private static final class ConsistentHashSelector<T> {
        ...
        public ConsistentHashSelector(final List<Invoker<T>> invokers, final String methodName,
        ...
        public Invoker<T> select(final Invocation invocation) {
        ...
        private Invoker<T> sekectForKey(final long hash) {
            Invoker<T> invoker;
            Long key = hash;
