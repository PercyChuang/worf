...
final public class MockInvoker<T> implements Invoker<T> {
    ...
    public MockInvoker(final URL url) {
        this.url = url;
    }
    ...
    private Throwable getThrowable(final String throwstr) {
    ...
    public static Object parseMockValue(final String mock) throws Exception {
        return parseMockValue(mock, null);
    }

    public static Object parseMockValue(final String mock, final Type[] returnTypes) throws Exception {
        Object value = null;
