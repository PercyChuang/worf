...
public class ConditionRouter implements Router, Comparable<Router> {
    ...
    public ConditionRouter(final URL url) {
        this.url = url;
        ...
        try {
            ...
            Map<String, MatchPair> when = StringUtils.isBlank(whenRule) || "true".equals(whenRule) ? new HashMap<String, MatchPair>()
                    : parseRule(whenRule);
    ...
    @Override
    public <T> List<Invoker<T>> route(final List<Invoker<T>> invokers, final URL url, final Invocation invocation)
            throws RpcException {
    ...
    public boolean matchWhen(final URL url) {
        return matchCondition(whenCondition, url, null);
    }

    public boolean matchThen(final URL url, final URL param) {
        return thenCondition != null && matchCondition(thenCondition, url, param);
    }

    private boolean matchCondition(final Map<String, MatchPair> condition, final URL url, final URL param) {
    ...
    private static Map<String, MatchPair> parseRule(final String rule) throws ParseException {
    ...
    private static final class MatchPair {
        ...
        public boolean isMatch(final String value, final URL param) {
