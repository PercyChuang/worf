...
public class InvokeTelnetHandler implements TelnetHandler {
    ...
    public String telnet(final Channel channel, final String message) {
        ...
        List<Object> list;
        try {
            list = JSON.parse("[" + args + "]", List.class);
        } catch (Throwable t) {
        ...
        if (invoker != null) {
            if (invokeMethod != null) {
                try {
                    ...
                    RpcContext.getContext().setLocalAddress(channel.getLocalAddress())
    ...
    private static Method findMethod(final Exporter<?> exporter, final String method, final List<Object> args) {
    ...
    private static boolean isMatch(final Class<?>[] types, final List<Object> args) {
