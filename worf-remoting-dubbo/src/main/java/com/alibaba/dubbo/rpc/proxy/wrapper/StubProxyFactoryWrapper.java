...
public class StubProxyFactoryWrapper implements ProxyFactory {
    ...
    public StubProxyFactoryWrapper(final ProxyFactory proxyFactory) {
                    ...
                    try {
                        ...
                        throw new IllegalStateException(
                                "No such constructor \"public " + stubClass.getSimpleName() + "("
                                        + serviceType.getName() + ")\" in stub implemention class "
                                        + stubClass.getName(), e);
                    }
                } catch (Throwable t) {
                    LOGGER.error(
                            "Failed to create stub implemention class " + stub + " in consumer "
    ...
    private <T> Exporter<T> export(final T instance, final Class<T> type, final URL url) {
