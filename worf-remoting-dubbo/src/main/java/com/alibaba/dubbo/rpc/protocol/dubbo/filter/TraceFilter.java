...
public class TraceFilter implements Filter {
    ...
    public static void addTracer(final Class<?> type, final String method, final Channel channel, final int max) {
    ...
    public static void removeTracer(final Class<?> type, final String method, final Channel channel) {
