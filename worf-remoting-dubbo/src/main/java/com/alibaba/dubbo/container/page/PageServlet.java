...
public class PageServlet extends HttpServlet {
    ...
    protected final void writeMenu(final HttpServletRequest request, final PrintWriter writer, final String nav) {
        writer.println("<table>");
        writer.println("<thead>");
        writer.println("    <tr>");
    ...
    protected final void writeTable(final PrintWriter writer, final String title, final List<String> columns,
