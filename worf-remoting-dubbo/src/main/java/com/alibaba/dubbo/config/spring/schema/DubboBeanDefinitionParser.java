...
public class DubboBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public DubboBeanDefinitionParser(final Class<?> beanClass, final boolean required) {
    ...
    private static BeanDefinition parse(final Element element, final ParserContext parserContext,
            final Class<?> beanClass, final boolean required) {
    ...
    protected static MonitorConfig convertMonitor(final String monitor) {
    ...
    @SuppressWarnings("unchecked")
    private static void parseMultiRef(final String property, final String value,
            final RootBeanDefinition beanDefinition, final ParserContext parserContext) {
    ...
    private static void parseNested(final Element element, final ParserContext parserContext, final Class<?> beanClass,
            final boolean required, final String tag, final String property, final String ref,
    ...
    private static void parseProperties(final NodeList nodeList, final RootBeanDefinition beanDefinition) {
        if (nodeList != null && nodeList.getLength() > 0) {
            for (int i = 0; i < nodeList.getLength(); i++) {
                Node node = nodeList.item(i);
                if (node instanceof Element) {
    ...
    @SuppressWarnings("unchecked")
    private static ManagedMap parseParameters(final NodeList nodeList, final RootBeanDefinition beanDefinition) {
        if (nodeList != null && nodeList.getLength() > 0) {
            ManagedMap parameters = null;
            for (int i = 0; i < nodeList.getLength(); i++) {
                Node node = nodeList.item(i);
    ...
    @SuppressWarnings("unchecked")
    private static void parseMethods(final String id, final NodeList nodeList, final RootBeanDefinition beanDefinition,
    ...
    @SuppressWarnings("unchecked")
    private static void parseArguments(final String id, final NodeList nodeList,
            final RootBeanDefinition beanDefinition, final ParserContext parserContext) {
        if (nodeList != null && nodeList.getLength() > 0) {
