...
public class DubboRegistry extends FailbackRegistry {
    ...
    private final ScheduledExecutorService scheduledExecutorService = Executors.newScheduledThreadPool(1,
            new NamedThreadFactory("DubboRegistryReconnectTimer", true));
    ...
    public DubboRegistry(final Invoker<RegistryService> registryInvoker, final RegistryService registryService) {
