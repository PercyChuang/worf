...
public class RegistriesPageHandler implements PageHandler {
    ...
    @Override
    public Page handle(final URL url) {
        ...
        return new Page("Registries", "Registries (" + rows.size() + ")", new String[] { "Registry Address:", "Status",
                "Registered(" + registeredCount + ")", "Subscribed(" + subscribedCount + ")" }, rows);
    }
