...
public class TelnetUtils {
    ...
    public static String toList(final List<List<String>> table) {
    ...
    public static String toTable(final String[] header, final List<List<String>> table) {
        return toTable(Arrays.asList(header), table);
    }

    public static String toTable(final List<String> header, final List<List<String>> table) {
        int totalWidth = 0;
