...
public class ExchangeCodec extends TelnetCodec {
    ...
    @Override
    protected Object decode(final Channel channel, final ChannelBuffer buffer, final int readable, byte[] header)
            throws IOException {
        // check magic number.
    ...
    protected void encodeRequest(final Channel channel, final ChannelBuffer buffer, final Request req)
            throws IOException {
    ...
    protected void encodeResponse(final Channel channel, final ChannelBuffer buffer, final Response res)
            throws IOException {
        try {
            Serialization serialization = getSerialization(channel);
            // header.
    ...
    @Deprecated
    protected Object decodeHeartbeatData(final ObjectInput in) throws IOException {
        try {
    ...
    protected Object decodeEventData(final Channel channel, final ObjectInput in) throws IOException {
        try {
            return in.readObject();
        } catch (ClassNotFoundException e) {
            throw new IOException(StringUtils.toString("Read object failed.", e));
    ...
    @Deprecated
    protected Object decodeHeartbeatData(final Channel channel, final ObjectInput in) throws IOException {
        try {
            return in.readObject();
        } catch (ClassNotFoundException e) {
            throw new IOException(StringUtils.toString("Read object failed.", e));
    ...
    protected Object decodeResponseData(final Channel channel, final ObjectInput in, final Object requestData)
            throws IOException {
    ...
    @Deprecated
    protected void encodeHeartbeatData(final Channel channel, final ObjectOutput out, final Object data)
            throws IOException {
        encodeHeartbeatData(out, data);
    }

    protected void encodeRequestData(final Channel channel, final ObjectOutput out, final Object data)
            throws IOException {
        encodeRequestData(out, data);
    }

    protected void encodeResponseData(final Channel channel, final ObjectOutput out, final Object data)
            throws IOException {
