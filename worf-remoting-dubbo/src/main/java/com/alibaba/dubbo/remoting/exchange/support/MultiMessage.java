...
public final class MultiMessage implements Iterable {
    ...
    public static MultiMessage createFromCollection(final Collection collection) {
        MultiMessage result = new MultiMessage();
        result.addMessages(collection);
        return result;
    }

    public static MultiMessage createFromArray(final Object... args) {
    ...
    public void addMessages(final Collection collection) {
