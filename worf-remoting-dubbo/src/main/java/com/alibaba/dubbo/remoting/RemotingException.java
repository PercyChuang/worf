...
public class RemotingException extends Exception {
    ...
    public RemotingException(final Channel channel, final String msg) {
        this(channel == null ? null : channel.getLocalAddress(), channel == null ? null : channel.getRemoteAddress(),
                msg);
    }

    public RemotingException(final InetSocketAddress localAddress, final InetSocketAddress remoteAddress,
    ...
    public RemotingException(final Channel channel, final Throwable cause) {
        this(channel == null ? null : channel.getLocalAddress(), channel == null ? null : channel.getRemoteAddress(),
                cause);
    }
    ...
    public RemotingException(final Channel channel, final String message, final Throwable cause) {
        this(channel == null ? null : channel.getLocalAddress(), channel == null ? null : channel.getRemoteAddress(),
                message, cause);
    }
