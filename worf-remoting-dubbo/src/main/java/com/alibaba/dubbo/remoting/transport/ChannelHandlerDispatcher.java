...
public class ChannelHandlerDispatcher implements ChannelHandler {
    ...
    public ChannelHandlerDispatcher(final ChannelHandler... handlers) {
        this(handlers == null ? null : Arrays.asList(handlers));
    }

    public ChannelHandlerDispatcher(final Collection<ChannelHandler> handlers) {
    ...
    public ChannelHandlerDispatcher addChannelHandler(final ChannelHandler handler) {
        this.channelHandlers.add(handler);
        return this;
    }

    public ChannelHandlerDispatcher removeChannelHandler(final ChannelHandler handler) {
