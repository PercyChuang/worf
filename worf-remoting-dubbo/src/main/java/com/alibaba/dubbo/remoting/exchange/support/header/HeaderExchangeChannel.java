...
final class HeaderExchangeChannel implements ExchangeChannel {
    ...
    HeaderExchangeChannel(final Channel channel) {
        if (channel == null) {
    ...
    static HeaderExchangeChannel getOrAddChannel(final Channel ch) {
        if (ch == null) {
            return null;
        }
    ...
    static void removeChannelIfDisconnected(final Channel ch) {
