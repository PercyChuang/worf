...
public class HeaderExchangeHandler implements ChannelHandlerDelegate {
    ...
    public HeaderExchangeHandler(final ExchangeHandler handler) {
        if (handler == null) {
    ...
    void handlerEvent(final Channel channel, final Request req) throws RemotingException {
        if (req.getData() != null && req.getData().equals(Request.READONLY_EVENT)) {
            channel.setAttribute(Constants.CHANNEL_ATTRIBUTE_READONLY_KEY, Boolean.TRUE);
        }
    }

    Response handleRequest(final ExchangeChannel channel, final Request req) throws RemotingException {
    ...
    static void handleResponse(final Channel channel, final Response response) throws RemotingException {
    ...
    private static boolean isClientSide(final Channel channel) {
