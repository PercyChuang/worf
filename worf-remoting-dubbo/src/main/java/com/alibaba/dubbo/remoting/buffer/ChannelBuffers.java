...
public final class ChannelBuffers {
    ...
    public static ChannelBuffer dynamicBuffer(final int capacity) {
        return new DynamicChannelBuffer(capacity);
    }

    public static ChannelBuffer dynamicBuffer(final int capacity, final ChannelBufferFactory factory) {
