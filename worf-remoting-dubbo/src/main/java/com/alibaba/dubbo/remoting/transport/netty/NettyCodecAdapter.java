...
final class NettyCodecAdapter {
    ...
    public NettyCodecAdapter(final Codec2 codec, final URL url, final com.alibaba.dubbo.remoting.ChannelHandler handler) {
        this.codec = codec;
        this.url = url;
    ...
    private class InternalEncoder extends OneToOneEncoder {
        ...
        @Override
        protected Object encode(final ChannelHandlerContext ctx, final Channel ch, final Object msg) throws Exception {
        ...
        public void messageReceived(final ChannelHandlerContext ctx, final MessageEvent event) throws Exception {
            ...
            if (buffer.readable()) {
                if (buffer instanceof DynamicChannelBuffer) {
                    ...
                    message = com.alibaba.dubbo.remoting.buffer.ChannelBuffers.dynamicBuffer(size > bufferSize ? size
                            : bufferSize);
