...
public class CuratorZookeeperClient extends AbstractZookeeperClient<CuratorWatcher> {
    ...
    public CuratorZookeeperClient(final URL url) {
        super(url);
        try {
    ...
    private class CuratorWatcherImpl implements CuratorWatcher {
        ...
        public CuratorWatcherImpl(final ChildListener listener) {
    ...
    @Override
    public CuratorWatcher createTargetChildListener(final String path, final ChildListener listener) {
        return new CuratorWatcherImpl(listener);
    }

    @Override
    public List<String> addTargetChildListener(final String path, final CuratorWatcher listener) {
        try {
    ...
    @Override
    public void removeTargetChildListener(final String path, final CuratorWatcher listener) {
