...
public class TimeoutException extends RemotingException {
    ...
    public TimeoutException(final boolean serverSide, final Channel channel, final String message) {
        super(channel, message);
        this.phase = serverSide ? SERVER_SIDE : CLIENT_SIDE;
    }

    public TimeoutException(final boolean serverSide, final InetSocketAddress localAddress,
