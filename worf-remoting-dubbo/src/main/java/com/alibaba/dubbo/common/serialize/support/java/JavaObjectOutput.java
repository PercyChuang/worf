...
public class JavaObjectOutput extends NativeJavaObjectOutput {
    public JavaObjectOutput(final OutputStream os) throws IOException {
        super(new ObjectOutputStream(os));
    }

    public JavaObjectOutput(final OutputStream os, final boolean compact) throws IOException {
