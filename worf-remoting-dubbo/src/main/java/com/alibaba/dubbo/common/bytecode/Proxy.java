...
public abstract class Proxy {
     ...
     */
    public static Proxy getProxy(final Class<?>... ics) {
     ...
     * @return Proxy instance.
     */
    public static Proxy getProxy(final ClassLoader cl, final Class<?>... ics) {
        if (ics.length > 65535) {
    ...
    private static String asArgument(final Class<?> cl, final String name) {
        if (cl.isPrimitive()) {
            if (Boolean.TYPE == cl) {
