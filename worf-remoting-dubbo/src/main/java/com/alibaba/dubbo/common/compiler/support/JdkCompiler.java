...
public class JdkCompiler extends AbstractCompiler {
    ...
    @Override
    public Class<?> doCompile(final String name, final String sourceCode) throws Throwable {
    ...
    private static final class JavaFileManagerImpl extends ForwardingJavaFileManager<JavaFileManager> {
        ...
        public JavaFileManagerImpl(final JavaFileManager fileManager, final ClassLoaderImpl classLoader) {
            super(fileManager);
        ...
        public JavaFileObject getJavaFileForOutput(final Location location, final String qualifiedName,
                final Kind kind, final FileObject outputFile) throws IOException {
