...
public class ConfigUtils {
    ...
    public static boolean isDefault(final String value) {
        return "true".equalsIgnoreCase(value) || "default".equalsIgnoreCase(value);
    }

    /**
     * 扩展点列表中插入缺省扩展点。 <p> 扩展点列表支持<ul> <li>特殊值<code><strong>default</strong></code>，表示缺省扩展点插入的位置
     ...
     */
    public static List<String> mergeValues(final Class<?> type, final String cfg, final List<String> def) {
        ...
        // 加入初始值
        String[] configs = cfg == null || cfg.trim().length() == 0 ? new String[0] : Constants.COMMA_SPLIT_PATTERN
                .split(cfg);
    ...
    public static String replaceProperty(final String expression, final Map<String, String> params) {
    ...
    public static Properties loadProperties(final String fileName, final boolean allowMultiFile) {
     ...
     */
    public static Properties loadProperties(final String fileName, final boolean allowMultiFile, final boolean optional) {
