...
public final class Version {
    ...
    public static void checkDuplicate(final Class<?> cls, final boolean failOnError) {
    ...
    public static void checkDuplicate(final String path, final boolean failOnError) {
        try {
            // 在ClassPath搜文件
