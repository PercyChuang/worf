...
public final class StringUtils {
    ...
    public static int parseInteger(final String str) {
        if (!isInteger(str)) {
            return 0;
        }
    ...
    /**
     * Returns true if s is a legal Java identifier.<p> <a
     * href="http://www.exampledepot.com/egs/java.lang/IsJavaId.html">more info.</a>
     */
    ...
    public static boolean isContains(final String values, final String value) {
     ...
     * @return String.
     */
    public static String translat(final String src, final String from, final String to) {
        if (isEmpty(src)) {
            return src;
        }
     ...
     * @return string array.
     */
    public static String[] split(final String str, final char ch) {
     ...
     */
    private static Map<String, String> parseKeyValuePair(final String str, final String itemSeparator) {
        String[] tmp = str.split(itemSeparator);
        Map<String, String> map = new HashMap<String, String>(tmp.length);
        for (String element : tmp) {
            Matcher matcher = KVP_PATTERN.matcher(element);
    ...
    public static String getQueryStringValue(final String qs, final String key) {
     ...
     */
    public static Map<String, String> parseQueryString(final String qs) {
    ...
    public static String getServiceKey(final Map<String, String> ps) {
    ...
    public static String toQueryString(final Map<String, String> ps) {
        StringBuilder buf = new StringBuilder();
    ...
    public static String toArgumentString(final Object[] args) {
        StringBuilder buf = new StringBuilder();
        for (Object arg : args) {
            if (buf.length() > 0) {
