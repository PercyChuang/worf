...
class J2oVisitor implements JSONVisitor {
    ...
    J2oVisitor(final Class<?> type, final JSONConverter jc) {
        mType = type;
        mConverter = jc;
    }

    J2oVisitor(final Class<?>[] types, final JSONConverter jc) {
        mTypes = types;
        mConverter = jc;
    }
    ...
    @Override
    public Object end(final Object obj, final boolean isValue) throws ParseException {
        mStack.clear();
        try {
    ...
    @Override
    public Object objectEnd(final int count) {
        Object ret = mValue;
    ...
    @Override
    public void objectItem(final String name) {
    ...
    public void objectItemValue(Object obj, final boolean isValue) throws ParseException {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public Object arrayEnd(final int count) throws ParseException {
        Object ret;
    ...
    @Override
    public void arrayItem(final int index) throws ParseException {
    ...
    @Override
    public void arrayItemValue(final int index, Object obj, final boolean isValue) throws ParseException {
        if (isValue && obj != null) {
            try {
                obj = mConverter.readValue(mType, obj);
            } catch (IOException e) {
    ...
    private static Object toArray(final Class<?> c, final Stack<Object> list, final int len) throws ParseException {
        if (c == String.class) {
            if (len == 0) {
    ...
    private static String name(final Class<?>[] types) {
