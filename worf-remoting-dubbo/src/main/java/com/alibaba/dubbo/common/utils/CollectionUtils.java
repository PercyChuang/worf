...
public class CollectionUtils {
    ...
    public static List<String> sortSimpleName(final List<String> list) {
        if (list != null && list.size() > 0) {
    ...
    public static Map<String, Map<String, String>> splitAll(final Map<String, List<String>> list, final String separator) {
        if (list == null) {
            return null;
        }
    ...
    public static Map<String, List<String>> joinAll(final Map<String, Map<String, String>> map, final String separator) {
        if (map == null) {
            return null;
        }
    ...
    public static Map<String, String> split(final List<String> list, final String separator) {
        if (list == null) {
            return null;
        }
    ...
    public static List<String> join(final Map<String, String> map, final String separator) {
        if (map == null) {
            return null;
        }
