...
public class GenericObjectInput extends GenericDataInput implements ObjectInput {
    ...
    public GenericObjectInput(final InputStream is) {
        this(is, Builder.DEFAULT_CLASS_DESCRIPTOR_MAPPER);
    }

    public GenericObjectInput(final InputStream is, final ClassDescriptorMapper mapper) {
        super(is);
        mMapper = mapper;
    }

    public GenericObjectInput(final InputStream is, final int buffSize) {
        this(is, buffSize, Builder.DEFAULT_CLASS_DESCRIPTOR_MAPPER);
    }

    public GenericObjectInput(final InputStream is, final int buffSize, final ClassDescriptorMapper mapper) {
        super(is, buffSize);
        mMapper = mapper;
    }
    ...
    public Object readObject() throws IOException {
        ...
        switch (b) {
            ...
            default:
                throw new IOException("Flag error, expect OBJECT_NULL|OBJECT_DUMMY|OBJECT_DESC|OBJECT_DESC_ID, get "
                        + b);
        }
        try {
    ...
    public void addRef(final Object obj) {
        mRefs.add(obj);
    }

    public Object getRef(final int index) throws IOException {
