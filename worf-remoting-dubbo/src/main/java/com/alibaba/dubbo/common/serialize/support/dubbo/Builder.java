...
public abstract class Builder<T> implements GenericDataFlags {
    ...
    public static ClassDescriptorMapper DEFAULT_CLASS_DESCRIPTOR_MAPPER = new ClassDescriptorMapper() {
        ...
        @Override
        public int getDescriptorIndex(final String desc) {
    ...
    public void writeTo(final T obj, final OutputStream os) throws IOException {
        GenericObjectOutput out = new GenericObjectOutput(os);
        writeTo(obj, out);
        out.flushBuffer();
    }

    public T parseFrom(final byte[] b) throws IOException {
        return parseFrom(new UnsafeByteArrayInputStream(b));
    }

    public T parseFrom(final InputStream is) throws IOException {
    ...
    public static <T> Builder<T> register(final Class<T> c, final boolean isAllowNonSerializable) {
    ...
    public static <T> Builder<T> register(final Class<T> c) {
        return register(c, false);
    }

    public static <T> void register(final Class<T> c, final Builder<T> b) {
    ...
    private static <T> Builder<T> newBuilder(final Class<T> c) {
        if (c.isPrimitive()) {
    ...
    private static Builder<?> newArrayBuilder(final Class<?> c) {
        ...
        StringBuilder cwt = new StringBuilder("public void writeTo(Object obj, ").append(
                GenericObjectOutput.class.getName()).append(" out) throws java.io.IOException{"); // writeTo code.
        ...
        cwt.append(cn)
                .append(" v = (")
                .append(cn)
                .append(")$1; int len = v.length; $2.write0(OBJECT_VALUES); $2.writeUInt(len); for(int i=0;i<len;i++){ ");
    ...
    private static Builder<?> newObjectBuilder(final Class<?> c) {
        ...
        if (c.getClassLoader() == null) // is system class. if( cn.startsWith("java.") || cn.startsWith("javax.") ||
                                        // cn.startsWith("sun.") )
        {
            isp = false;
            ...
            try {
                ...
                if (len > 0) {
                    if (len > MAX_FIELD_CONFIG_FILE_SIZE) {
                        throw new RuntimeException("Load [" + c.getName()
                                + "] field-config file error: File-size too larger");
                    }
        ...
        // writeObject code.
        StringBuilder cwf = new StringBuilder("protected void writeObject(Object obj, ").append(
                GenericObjectOutput.class.getName()).append(" out) throws java.io.IOException{");
        cwf.append(cn).append(" v = (").append(cn).append(")$1; ");
        cwf.append("$2.writeInt(fields.length);");

        // readObject code.
        StringBuilder crf = new StringBuilder("protected void readObject(Object ret, ").append(
                GenericObjectInput.class.getName()).append(" in) throws java.io.IOException{");
        ...
        // newInstance code.
        StringBuilder cni = new StringBuilder("protected Object newInstance(").append(
                GenericObjectInput.class.getName()).append(" in){ return ");
    ...
    private static Builder<?> newEnumBuilder(final Class<?> c) {
        ClassLoader cl = ClassHelper.getCallerClassLoader(Builder.class);
    ...
    private static Map<String, PropertyMetadata> propertyMetadatas(final Class<?> c) {
    ...
    private static String propertyName(final String s) {
        return s.length() == 1 || Character.isLowerCase(s.charAt(1)) ? Character.toLowerCase(s.charAt(0))
                + s.substring(1) : s;
    }

    private static boolean serializeIgnoreFinalModifier(final Class cl) {
    ...
    private static boolean isPrimitiveOrPrimitiveArray1(final Class<?> cl) {
        if (cl.isPrimitive()) {
            return true;
        } else {
    ...
    private static String defaultArg(final Class<?> cl) {
        if (boolean.class == cl) {
            return "false";
        }
        if (int.class == cl) {
    ...
    private static int compareFieldName(final String n1, final String n2) {
    ...
    private static void addDesc(final Class<?> c) {
    ...
    public static abstract class AbstractObjectBuilder<T> extends Builder<T> {
        ...
        @Override
        public void writeTo(final T obj, final GenericObjectOutput out) throws IOException {
            if (obj == null) {
        ...
        @Override
        public T parseFrom(final GenericObjectInput in) throws IOException {
            byte b = in.read0();
            switch (b) {
                case OBJECT: {
    ...
    static final Builder<Object> GenericBuilder = new Builder<Object>() {
        ...
        @Override
        public void writeTo(final Object obj, final GenericObjectOutput out) throws IOException {
            out.writeObject(obj);
        }

        @Override
        public Object parseFrom(final GenericObjectInput in) throws IOException {
    ...
    static final Builder<Object[]> GenericArrayBuilder = new AbstractObjectBuilder<Object[]>() {
        ...
        @Override
        protected Object[] newInstance(final GenericObjectInput in) throws IOException {
            return new Object[in.readUInt()];
        }

        @Override
        protected void readObject(final Object[] ret, final GenericObjectInput in) throws IOException {
        ...
        @Override
        protected void writeObject(final Object[] obj, final GenericObjectOutput out) throws IOException {
    ...
    static final Builder<Serializable> SerializableBuilder = new Builder<Serializable>() {
        ...
        @Override
        public void writeTo(final Serializable obj, final GenericObjectOutput out) throws IOException {
            if (obj == null) {
                out.write0(OBJECT_NULL);
            } else {
        ...
        @Override
        public Serializable parseFrom(final GenericObjectInput in) throws IOException {
            byte b = in.read0();
            if (b == OBJECT_NULL) {
                return null;
            }
    ...
    static {
        ...
        register(byte[].class, new Builder<byte[]>() {
            ...
            @Override
            public void writeTo(final byte[] obj, final GenericObjectOutput out) throws IOException {
                out.writeBytes(obj);
            }

            @Override
            public byte[] parseFrom(final GenericObjectInput in) throws IOException {
                return in.readBytes();
            }
        });
        register(Boolean.class, new Builder<Boolean>() {
            ...
            @Override
            public void writeTo(final Boolean obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
            ...
            @Override
            public Boolean parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                switch (b) {
                    case VARINT_N1:
                        return null;
        ...
        register(Character.class, new Builder<Character>() {
            ...
            @Override
            public void writeTo(final Character obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public Character parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(Short.class, new Builder<Short>() {
            ...
            @Override
            public void writeTo(final Short obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public Short parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(Integer.class, new Builder<Integer>() {
            ...
            @Override
            public void writeTo(final Integer obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public Integer parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(Long.class, new Builder<Long>() {
            ...
            @Override
            public void writeTo(final Long obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public Long parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(Float.class, new Builder<Float>() {
            ...
            @Override
            public void writeTo(final Float obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public Float parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(Double.class, new Builder<Double>() {
            ...
            @Override
            public void writeTo(final Double obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public Double parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(String.class, new Builder<String>() {
            ...
            @Override
            public String parseFrom(final GenericObjectInput in) throws IOException {
                return in.readUTF();
            }

            @Override
            public void writeTo(final String obj, final GenericObjectOutput out) throws IOException {
                out.writeUTF(obj);
            }
        });
        register(StringBuilder.class, new Builder<StringBuilder>() {
            ...
            @Override
            public StringBuilder parseFrom(final GenericObjectInput in) throws IOException {
                return new StringBuilder(in.readUTF());
            }

            @Override
            public void writeTo(final StringBuilder obj, final GenericObjectOutput out) throws IOException {
        ...
        register(StringBuffer.class, new Builder<StringBuffer>() {
            ...
            @Override
            public StringBuffer parseFrom(final GenericObjectInput in) throws IOException {
                return new StringBuffer(in.readUTF());
            }

            @Override
            public void writeTo(final StringBuffer obj, final GenericObjectOutput out) throws IOException {
                out.writeUTF(obj.toString());
            }
        });
        ...
        register(ArrayList.class, new Builder<ArrayList>() {
            ...
            @Override
            public void writeTo(final ArrayList obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
            ...
            @Override
            public ArrayList parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(HashMap.class, new Builder<HashMap>() {
            ...
            @Override
            public void writeTo(final HashMap obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
            ...
            @Override
            public HashMap parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(HashSet.class, new Builder<HashSet>() {
            ...
            @Override
            public void writeTo(final HashSet obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUES);
            ...
            @Override
            public HashSet parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(Date.class, new Builder<Date>() {
            ...
            @Override
            public void writeTo(final Date obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public Date parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(java.sql.Date.class, new Builder<java.sql.Date>() {
            ...
            @Override
            public void writeTo(final java.sql.Date obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public java.sql.Date parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(java.sql.Timestamp.class, new Builder<java.sql.Timestamp>() {
            ...
            @Override
            public void writeTo(final java.sql.Timestamp obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public java.sql.Timestamp parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
        ...
        register(java.sql.Time.class, new Builder<java.sql.Time>() {
            ...
            @Override
            public void writeTo(final java.sql.Time obj, final GenericObjectOutput out) throws IOException {
                if (obj == null) {
                    out.write0(OBJECT_NULL);
                } else {
                    out.write0(OBJECT_VALUE);
            ...
            @Override
            public java.sql.Time parseFrom(final GenericObjectInput in) throws IOException {
                byte b = in.read0();
                if (b == OBJECT_NULL) {
                    return null;
                }
