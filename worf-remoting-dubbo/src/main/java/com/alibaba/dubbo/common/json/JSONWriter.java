...
public class JSONWriter {
    ...
    public JSONWriter(final OutputStream is, final String charset) throws UnsupportedEncodingException {
     ...
     * @throws IOException.
     */
    public JSONWriter objectItem(final String name) throws IOException {
        beforeObjectItem();
     ...
     * @throws IOException
     */
    public JSONWriter valueString(final String value) throws IOException {
        beforeValue();
     ...
     * @throws IOException
     */
    public JSONWriter valueBoolean(final boolean value) throws IOException {
        beforeValue();
     ...
     * @throws IOException
     */
    public JSONWriter valueInt(final int value) throws IOException {
        beforeValue();
     ...
     * @throws IOException
     */
    public JSONWriter valueLong(final long value) throws IOException {
        beforeValue();
     ...
     * @throws IOException
     */
    public JSONWriter valueFloat(final float value) throws IOException {
        beforeValue();
     ...
     * @throws IOException
     */
    public JSONWriter valueDouble(final double value) throws IOException {
        beforeValue();
