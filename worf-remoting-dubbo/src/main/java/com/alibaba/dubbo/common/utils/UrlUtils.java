...
public class UrlUtils {
    ...
    public static URL parseURL(final String address, final Map<String, String> defaults) {
        ...
        /*
         * if (u.isAnyHost() || u.isLocalHost()) { changed = true; host = NetUtils.getLocalHost(); }
         */
        if (port <= 0) {
            if (defaultPort > 0) {
                changed = true;
    ...
    public static List<URL> parseURLs(final String address, final Map<String, String> defaults) {
        if (address == null || address.length() == 0) {
            return null;
        }
    ...
    public static Map<String, Map<String, String>> convertRegister(final Map<String, Map<String, String>> register) {
    ...
    public static Map<String, String> convertSubscribe(final Map<String, String> subscribe) {
    ...
    public static Map<String, Map<String, String>> revertRegister(final Map<String, Map<String, String>> register) {
        Map<String, Map<String, String>> newRegister = new HashMap<String, Map<String, String>>();
        for (Map.Entry<String, Map<String, String>> entry : register.entrySet()) {
            String serviceName = entry.getKey();
            Map<String, String> serviceUrls = entry.getValue();
    ...
    public static Map<String, String> revertSubscribe(final Map<String, String> subscribe) {
        Map<String, String> newSubscribe = new HashMap<String, String>();
        for (Map.Entry<String, String> entry : subscribe.entrySet()) {
            String serviceName = entry.getKey();
            String serviceQuery = entry.getValue();
    ...
    public static Map<String, Map<String, String>> revertNotify(final Map<String, Map<String, String>> notify) {
    ...
    public static List<String> revertForbid(final List<String> forbid, final Set<URL> subscribed) {
    ...
    public static URL getEmptyUrl(String service, final String category) {
        String group = null;
        String version = null;
        ...
        return URL.valueOf(Constants.EMPTY_PROTOCOL + "://0.0.0.0/" + service + "?" + Constants.CATEGORY_KEY + "="
                + category + (group == null ? "" : "&" + Constants.GROUP_KEY + "=" + group)
                + (version == null ? "" : "&" + Constants.VERSION_KEY + "=" + version));
    }

    public static boolean isMatchCategory(final String category, final String categories) {
    ...
    public static boolean isMatch(final URL consumerUrl, final URL providerUrl) {
        String consumerInterface = consumerUrl.getServiceInterface();
        String providerInterface = providerUrl.getServiceInterface();
        if (!(Constants.ANY_VALUE.equals(consumerInterface) || StringUtils.isEquals(consumerInterface,
                providerInterface))) {
            return false;
        }
        ...
        return (Constants.ANY_VALUE.equals(consumerGroup) || StringUtils.isEquals(consumerGroup, providerGroup) || StringUtils
                .isContains(consumerGroup, providerGroup))
                && (Constants.ANY_VALUE.equals(consumerVersion) || StringUtils.isEquals(consumerVersion,
                        providerVersion))
                && (consumerClassifier == null || Constants.ANY_VALUE.equals(consumerClassifier) || StringUtils
                        .isEquals(consumerClassifier, providerClassifier));
    }

    public static boolean isMatchGlobPattern(String pattern, final String value, final URL param) {
    ...
    public static boolean isMatchGlobPattern(final String pattern, final String value) {
        if ("*".equals(pattern)) {
            return true;
        }
    ...
    public static boolean isServiceKeyMatch(final URL pattern, final URL value) {
     ...
     */
    static boolean isItemMatch(final String pattern, final String value) {
        if (pattern == null) {
            return value == null;
        } else {
