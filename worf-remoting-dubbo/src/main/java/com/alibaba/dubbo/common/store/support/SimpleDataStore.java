...
public class SimpleDataStore implements DataStore {
    ...
    @Override
    public Map<String, Object> get(final String componentName) {
    ...
    @Override
    public Object get(final String componentName, final String key) {
    ...
    @Override
    public void put(final String componentName, final String key, final Object value) {
    ...
    @Override
    public void remove(final String componentName, final String key) {
        if (!data.containsKey(componentName)) {
            return;
        }
