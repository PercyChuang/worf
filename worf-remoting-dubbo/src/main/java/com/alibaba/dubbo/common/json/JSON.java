...
public class JSON {
    ...
    private static class Entry {
        ...
        Entry(final byte s, final Object v) {
            state = s;
            value = v;
        }
    }
     ...
     * @throws IOException.
     */
    public static String json(final Object obj) throws IOException {
        if (obj == null) {
            return NULL;
        }
     ...
     * @throws IOException.
     */
    public static void json(final Object obj, final Writer writer) throws IOException {
        json(obj, writer, false);
    }

    public static void json(final Object obj, final Writer writer, final boolean writeClass) throws IOException {
        if (obj == null) {
            writer.write(NULL);
        } else {
     ...
     * @throws IOException.
     */
    public static String json(final Object obj, final String[] properties) throws IOException {
        if (obj == null) {
            return NULL;
        }
        StringWriter sw = new StringWriter();
    ...
    public static void json(final Object obj, final String[] properties, final Writer writer) throws IOException {
     ...
     * @throws IOException.
     */
    public static void json(final Object obj, final String[] properties, final Writer writer, final boolean writeClass)
            throws IOException {
        if (obj == null) {
            writer.write(NULL);
        } else {
    ...
    private static void json(final Object obj, final JSONWriter jb, final boolean writeClass) throws IOException {
        if (obj == null) {
            jb.valueNull();
        } else {
    ...
    private static void json(final Object obj, final String[] properties, final JSONWriter jb, final boolean writeClass)
            throws IOException {
        if (obj == null) {
            jb.valueNull();
        } else {
     ...
     */
    public static Object parse(final String json) throws ParseException {
     ...
     * @throws ParseException
     */
    public static <T> T parse(final String json, final Class<T> type) throws ParseException {
        StringReader reader = new StringReader(json);
        try {
    ...
    public static <T> T parse(final Reader reader, final Class<T> type) throws IOException, ParseException {
     ...
     * @throws ParseException
     */
    public static Object[] parse(final String json, final Class<?>[] types) throws ParseException {
        StringReader reader = new StringReader(json);
        try {
            return parse(reader, types);
        } catch (IOException e) {
            throw new ParseException(e.getMessage());
        } finally {
            reader.close();
     ...
     * @throws ParseException
     */
    public static Object[] parse(final Reader reader, final Class<?>[] types) throws IOException, ParseException {
     ...
     * @throws ParseException
     */
    public static Object parse(final String json, final JSONVisitor handler) throws ParseException {
        StringReader reader = new StringReader(json);
        try {
     ...
     * @throws ParseException
     */
    public static Object parse(final Reader reader, final JSONVisitor handler) throws IOException, ParseException {
        return parse(reader, handler, JSONToken.ANY);
    }

    private static Object parse(final Reader reader, final int expect) throws IOException, ParseException {
            ...
            switch (state) {
                ...
                case OBJECT_ITEM: {
                    switch (token.type) {
                        ...
                        {
                            stack.push(new Entry(OBJECT_ITEM, token.value));
                            state = OBJECT_VALUE;
                            break;
                        }
                        case JSONToken.NULL: {
    ...
    private static Object parse(final Reader reader, final JSONVisitor handler, final int expect) throws IOException,
            ParseException {
        JSONReader jr = new JSONReader(reader);
        JSONToken token = jr.nextToken(expect);
