...
public class GenericJSONConverter implements JSONConverter {
    ...
    public void writeValue(final Object obj, final JSONWriter jb, final boolean writeClass) throws IOException {
        if (obj == null) {
            jb.valueNull();
            return;
        }
        ...
        if (encoder != null) {
            ...
            for (String pn : pns) {
                if (obj instanceof Throwable
                        && ("localizedMessage".equals(pn) || "cause".equals(pn) || "stackTrace".equals(pn))) {
                    continue;
                }
    ...
    public Object readValue(final Class<?> c, final Object jv) throws IOException {
        if (jv == null) {
            return null;
        }
    ...
    static {
        ...
        Encoder e = new Encoder() {
            @Override
            public void encode(final Object obj, final JSONWriter jb) throws IOException {
        ...
        Decoder d = new Decoder() {
            @Override
            public Object decode(final Object jv) {
                return jv.toString();
            }
        };
        ...
        d = new Decoder() {
            @Override
            public Object decode(final Object jv) throws IOException {
