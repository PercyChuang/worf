...
public class GenericDataInput implements DataInput, GenericDataFlags {
    ...
    public GenericDataInput(final InputStream is) {
        this(is, 1024);
    }

    public GenericDataInput(final InputStream is, final int buffSize) {
        mInput = is;
    ...
    private long readVarint64() throws IOException {
        ...
        switch (b) {
            ...
            case VARINT40: {
                ...
                long ret = (long) b1 & 0xff | ((long) b2 & 0xff) << 8 | ((long) b3 & 0xff) << 16
                        | ((long) b4 & 0xff) << 24 | ((long) b5 & 0xff) << 32;
                if (b5 < 0) {
            ...
            case VARINT64: {
                ...
                return (long) b1 & 0xff | ((long) b2 & 0xff) << 8 | ((long) b3 & 0xff) << 16 | ((long) b4 & 0xff) << 24
                        | ((long) b5 & 0xff) << 32 | ((long) b6 & 0xff) << 40 | ((long) b7 & 0xff) << 48
                        | ((long) b8 & 0xff) << 56;
            }
            case VARINT_NF:
                return -15;
