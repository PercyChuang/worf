...
public class JSONReader {
    ...
    public JSONReader(final InputStream is, final String charset) throws UnsupportedEncodingException {
    ...
    public JSONToken nextToken(final int expect) throws IOException, ParseException {
    ...
    private static Yylex getLexer(final Reader reader) {
