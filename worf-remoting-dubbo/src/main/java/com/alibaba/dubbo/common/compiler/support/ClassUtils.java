...
public class ClassUtils {
    ...
    public static Object newInstance(final String name) {
        try {
    ...
    public static Class<?> _forName(final String className) throws ClassNotFoundException {
    ...
    private static Class<?> arrayForName(final String className) throws ClassNotFoundException {
    ...
    public static Boolean boxed(final boolean v) {
        return Boolean.valueOf(v);
    }

    public static Character boxed(final char v) {
        return Character.valueOf(v);
    }

    public static Byte boxed(final byte v) {
        return Byte.valueOf(v);
    }

    public static Short boxed(final short v) {
        return Short.valueOf(v);
    }

    public static Integer boxed(final int v) {
        return Integer.valueOf(v);
    }

    public static Long boxed(final long v) {
        return Long.valueOf(v);
    }

    public static Float boxed(final float v) {
        return Float.valueOf(v);
    }

    public static Double boxed(final double v) {
        return Double.valueOf(v);
    }

    public static Object boxed(final Object v) {
        return v;
    }

    public static boolean unboxed(final Boolean v) {
        return v == null ? false : v.booleanValue();
    }

    public static char unboxed(final Character v) {
        return v == null ? '\0' : v.charValue();
    }

    public static byte unboxed(final Byte v) {
        return v == null ? 0 : v.byteValue();
    }

    public static short unboxed(final Short v) {
        return v == null ? 0 : v.shortValue();
    }

    public static int unboxed(final Integer v) {
        return v == null ? 0 : v.intValue();
    }

    public static long unboxed(final Long v) {
        return v == null ? 0 : v.longValue();
    }

    public static float unboxed(final Float v) {
        return v == null ? 0 : v.floatValue();
    }

    public static double unboxed(final Double v) {
        return v == null ? 0 : v.doubleValue();
    }

    public static Object unboxed(final Object v) {
        return v;
    }
    ...
    public static boolean isBeforeJava5(final String javaVersion) {
        return javaVersion == null || javaVersion.length() == 0 || "1.0".equals(javaVersion)
                || "1.1".equals(javaVersion) || "1.2".equals(javaVersion) || "1.3".equals(javaVersion)
                || "1.4".equals(javaVersion);
    }

    public static boolean isBeforeJava6(final String javaVersion) {
    ...
    public static void checkBytecode(final String name, final byte[] bytecode) {
    ...
    public static String getSizeMethod(final Class<?> cls) {
        try {
    ...
    public static String getMethodName(final Method method, final Class<?>[] parameterClasses, final String rightCode) {
    ...
    public static Method searchMethod(final Class<?> currentClass, final String name, final Class<?>[] parameterTypes)
    ...
    public static String getInitCode(final Class<?> type) {
