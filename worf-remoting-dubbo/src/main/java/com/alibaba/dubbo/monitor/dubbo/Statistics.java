...
public class Statistics implements Serializable {
    ...
    public Statistics(final URL url) {
        this.url = url;
    ...
    public Statistics setApplication(final String application) {
    ...
    public Statistics setService(final String service) {
    ...
    public Statistics setMethod(final String method) {
        this.method = method;
        return this;
    }
    ...
    public Statistics setClient(final String client) {
        this.client = client;
        return this;
    }
    ...
    public Statistics setServer(final String server) {
        this.server = server;
        return this;
    }
