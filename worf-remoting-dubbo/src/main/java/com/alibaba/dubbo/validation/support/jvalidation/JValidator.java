...
public class JValidator implements Validator {
    ...
    public JValidator(final URL url) {
    ...
    @Override
    public void validate(final String methodName, final Class<?>[] parameterTypes, final Object[] arguments)
            throws Exception {
    ...
    private void validate(final Set<ConstraintViolation<?>> violations, final Object arg, final Class<?> clazz,
    ...
    private static MemberValue createMemberValue(final ConstPool cp, final CtClass type, final Object value)
